package com.ztsc.commonutils.customview.wheelview;
...
//    private ScrollView scrollView;
    ...
    public void setItemsNewData(List<String> list) {
        if (null == items) {
            items = new ArrayList<String>();
        }
        items.clear();
...
//            position = divided + offset + 1;
    ...
    public void setBackground(Drawable background) {
        ...
        if (viewWidth == 0 && mContext != null) {
//            viewWidth = ((Activity) mContext).getWindowManager().getDefaultDisplay().getWidth();
          /*  WindowManager windowManger = (WindowManager) mContext
                    .getSystemService(Context.WINDOW_SERVICE);
            viewWidth = windowManger.getDefaultDisplay().getWidth();*/
            try {
                viewWidth = ((Activity) mContext).getWindowManager().getDefaultDisplay().getWidth();
    ...
    private int dip2px(float dpValue) {
        ...
        try {
            ...
            WindowManager windowManger = (WindowManager) mContext
                    .getSystemService(Context.WINDOW_SERVICE);
            windowManger.getDefaultDisplay();
            DisplayMetrics displaysMetrics = new DisplayMetrics();
            windowManger.getDefaultDisplay().getMetrics(displaysMetrics);
