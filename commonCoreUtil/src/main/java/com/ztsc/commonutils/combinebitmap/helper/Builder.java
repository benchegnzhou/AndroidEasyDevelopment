package com.ztsc.commonutils.combinebitmap.helper;
...
import com.ztsc.commonutils.combinebitmap.layout.DingLayoutManager;
import com.ztsc.commonutils.combinebitmap.layout.ILayoutManager;
import com.ztsc.commonutils.combinebitmap.layout.WechatLayoutManager;
import com.ztsc.commonutils.combinebitmap.listener.OnProgressListener;
import com.ztsc.commonutils.combinebitmap.listener.OnSubItemClickListener;
import com.ztsc.commonutils.combinebitmap.region.DingRegionManager;
import com.ztsc.commonutils.combinebitmap.region.IRegionManager;
import com.ztsc.commonutils.combinebitmap.region.WechatRegionManager;
...
public class Builder {
    ...
    public int placeholder = R.drawable.ic_moren_touxiang_boy; // 获取图片失败时的默认图片
    public int icondefault = R.drawable.ic_moren_touxiang_boy; // 获取图片失败时的默认图片
    public int count; // 要加载的资源数量
    public int subSize; // 单个bitmap的尺寸
    public boolean isImgCircle = false; //单张图片设置为圆形
     ...
     * @return
     */
    public Builder setImgCircle(boolean imgCircle) {
        isImgCircle = imgCircle;
        return this;
    }
    ...
    public Builder setIconDefault(int icondefault) {
