...
import com.ztsc.commonutils.combinebitmap.listener.OnHandlerListener;
...
public class CombineHelper {
    ...
    private void loadByUrls(final Builder builder) {
        ...
        for (int i = 0; i < builder.count; i++) {
            ...
            BitmapLoader.getInstance(builder.context).asyncLoad(i, builder.urls[i],builder.icondefault, subSize, subSize, handler);
        }
    }
    ...
    private void setBitmap(final Builder b, Bitmap[] bitmaps) {
        Bitmap result = b.layoutManager.combineBitmap(b.size, b.subSize, b.gap, b.gapColor, bitmaps, b.isImgCircle);
        LoggerUtil.d("____wechat_ic_load");
        // 返回最终的组合Bitmap
