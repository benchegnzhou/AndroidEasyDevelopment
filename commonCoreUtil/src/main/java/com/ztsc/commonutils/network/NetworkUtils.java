...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            ...
            Utils.getApp().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    public static boolean isAvailableByPing() {
        ...
        if (result.errorMsg != null) {
            LoggerUtil.d("isAvailableByPing errorMsg", result.errorMsg);
        }
        if (result.successMsg != null) {
            LoggerUtil.d("isAvailableByPing successMsg", result.successMsg);
        }
        return ret;
    }
