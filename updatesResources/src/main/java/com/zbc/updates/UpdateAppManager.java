...
import com.zbc.updates.listener.IUpdateDialogFragmentListener;
...
public class UpdateAppManager {
    ...
    public static void download(final Context context, @NonNull final UpdateAppBean updateAppBean, @Nullable final DownloadService.DownloadCallback downloadCallback) {
        ...
        if (updateAppBean == null) {
            throw new NullPointerException("UpdateAppBean can not be null");
        }
...
//                || !mTargetPath.startsWith(preSuffix)
     ...
     * @param appMsgBean
     */
    public void saveVersionMsg(Context context, AppMsgBean appMsgBean) {
        AppUpdateUtils.saveNetVersionMsg(context, appMsgBean);
    }
     ...
     * 获取APP本地的安装包信息
     */
    public AppMsgBean getVersionMsgLoacal(Context context) {
        return AppUpdateUtils.getNetVersionMsg(context);
    }
