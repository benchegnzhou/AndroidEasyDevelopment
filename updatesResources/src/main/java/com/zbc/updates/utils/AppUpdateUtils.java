...
import com.zbc.updates.bean.AppMsgBean;
import com.zbc.updates.UpdateAppBean;
import com.zbc.updates.listener.ExceptionHandler;
import com.zbc.updates.listener.ExceptionHandlerHelper;
...
public class AppUpdateUtils {
    ...
    public static final String NET_VERSION_MSG = "net_version_msg";
     ...
     * @param appMsgBean
     */
    public static void saveNetVersionMsg(Context context, AppMsgBean appMsgBean) {
        try {
            getSP(context).edit().putString(NET_VERSION_MSG, new Gson().toJson(appMsgBean)).apply();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     * @return
     */
    public static AppMsgBean getNetVersionMsg(Context context) {
        AppMsgBean appMsgBean = null;
        try {
            new Gson().fromJson(getSP(context).getString(NET_VERSION_MSG, ""), AppMsgBean.class);
